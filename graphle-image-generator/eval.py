...
def generate(caption, wordtoix, ixtoword, text_encoder, netG, blob_service, copies=2):
    ...
    container_name = "ivyhackdatablob"
    full_path = "https://datablobivyhacks.blob.core.windows.net/ivyhackdatablob/%s"
...
def eval(caption):
    ...
    blob_service = BlockBlobService(account_name='datablobivyhacks', account_key=os.environ['KEY'])
